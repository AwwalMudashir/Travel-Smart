...
const TripRest = () => {
  ...
  const Dests = filteredDestinations.map((dest) => {
    return <Destination key={dest.id} {...dest} />;
  });

  return (
    <div className='bg-white pl-[2%] pb-[30px] pr-[2%]'>
      <h1 className='text-4xl pt-[40px] text-center pb-[40px]'>
        Our <span className='text-[#68C6C8]'>Destinations</span>
      </h1>
      <div className='flex gap-4'>
      <div className='left w-full md:w-[25%] p-6 bg-white shadow-lg rounded-xl'>
