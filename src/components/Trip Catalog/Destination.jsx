      ...
      <div className="p-6">
        ...
        <Link to={`/destination/${props.id}`}>
          <div className="w-full text-center">
            <button className="bg-gradient-to-r from-blue-500 to-teal-400 text-white font-semibold px-4 py-2 rounded-lg shadow-md hover:from-blue-600 hover:to-teal-500 transition-all duration-300 ease-in-out">
              See More
            </button>
          </div>
        </Link>
